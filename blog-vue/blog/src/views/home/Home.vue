...
<!--          qq-->
          <a
            ...
            target="_blank"
            href="http://wpa.qq.com/msgrd?v=3&uin=1540504013&site=qq&menu=yes"
          />
<!--          github-->
          <a
            target="_blank"
            href="https://github.com/zhencym"
            class="ml-5 mr-5 iconfont icongithub"
          />
<!--          gitee-->
          <a
            target="_blank"
            href="https://gitee.com/cyuming"
...
.home-banner {
  ...
  right: 0;
  height: 100vh;
  /*https://cymoss.oss-cn-guangzhou.aliyuncs.com/blog/cute266.jpg*/
  background: url(../../image/cute266.jpg) center
