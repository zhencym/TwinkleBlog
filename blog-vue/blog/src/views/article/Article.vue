      ...
      <v-col md="9" cols="12">
        <v-card class="article-wrapper">
          ...
          <div class="aritcle-copyright">
            <div>
              <span>文章作者：</span>
              <a href="http://43.139.142.79:81/" target="_blank"> Twinkle</a>
            </div>
            <div>
              <span>文章链接：</span>
              ...
              <div class="animated fadeInDown reward-main">
                <ul class="reward-all">
                  <li class="reward-item">
                    <img
                      class="reward-img"
                      src="https://cymoss.oss-cn-guangzhou.aliyuncs.com/image/wechat.png"
                    />
                  ...
                  <li class="reward-item">
                    <img
                      class="reward-img"
                      src="https://cymoss.oss-cn-guangzhou.aliyuncs.com/image/alipay.png"
                    />
